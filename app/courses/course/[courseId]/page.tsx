        ...
        <div className="flex flex-col items-center gap-15 mt-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <Link href={`/courses/course/${courseId}/notes`}>
                    <button className="flex flex-col items-center px-20 py-20 rounded-xl gap-8 w-full h-full">
            ...
            <Link href={`/courses/upload`}>
                <button className="flex flex-col items-center px-20 py-20 rounded-xl gap-8 w-200 h-full">
